...
In the case at hand the answer was "no", but I suspected there might be actually be a limit on the depth of nested parentheses.

Using the following Python script (which leverages the ability of the interpreter to evaluate expressions generated at runtime via `eval`), we can determine the answer is <span class='themecolor'>200</span>.
